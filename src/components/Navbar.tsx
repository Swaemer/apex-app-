...
import { MdLeaderboard, MdScience, MdAssignment, MdLocalOffer, MdAdminPanelSettings, MdDarkMode, MdLightMode, MdAssignmentReturn } from 'react-icons/md';
          ...
          <div className="flex items-center gap-2">
            ...
            {user?.isAdmin && (
              <button
                ...
                className={`px-4 py-2.5 rounded-lg font-medium transition-all flex items-center gap-2 ${
                  location.pathname === '/return-requests'
                    ? 'bg-gradient-to-r from-slate-600 to-slate-700 text-white shadow-sm'
                    : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
                }`}
              >
